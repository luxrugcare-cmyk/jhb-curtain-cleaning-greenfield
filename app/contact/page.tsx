...
export const metadata = { title: "Contact JHB Curtain Cleaning", description: "Contact JHB Curtain Cleaning by phone, WhatsApp, residential assessment or commercial site assessment for curtain and textile-cleaning enquiries.", alternates: { canonical: "/contact" } };
