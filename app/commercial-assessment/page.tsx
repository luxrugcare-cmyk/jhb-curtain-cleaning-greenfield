...
export const metadata = { title: "Request a Commercial Site Assessment", description: "Request a commercial curtain or textile-cleaning site assessment in Johannesburg for hospitality, offices, facilities and managed properties.", alternates: { canonical: "/commercial-assessment" } };
