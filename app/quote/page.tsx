...
export const metadata = { title: "Request a Residential Cleaning Assessment", description: "Request a residential curtain or textile-cleaning assessment in Johannesburg. Share the property, service requirement and optional photos for follow-up.", alternates: { canonical: "/quote" } };
