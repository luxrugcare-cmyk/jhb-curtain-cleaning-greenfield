...
export const metadata = { title: "Residential Curtain & Textile Cleaning", description: "Residential curtain, blind, upholstery, mattress, carpet and rug cleaning in Johannesburg, planned around fabric suitability and minimal disruption.", alternates: { canonical: "/residential" } };
