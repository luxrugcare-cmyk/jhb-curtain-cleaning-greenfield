...
export const metadata = { title: "Curtain & Textile Cleaning Results", description: "View JHB Curtain Cleaning project evidence and case-study information covering property type, textile scope, cleaning approach and documented outcomes.", alternates: { canonical: "/results" } };
